var faIcons = [
	...
	"fa fa-fw fa-ambulance",
	"fa fa-fw fa-anchor",
	"fa fa-fw fa-android",
	"fa fa-fw fa-angellist",
	"fa fa-fw fa-angle-double-down",
	"fa fa-fw fa-angle-double-left",
	"fa fa-fw fa-angle-double-right",
	"fa fa-fw fa-angle-double-up",
	"fa fa-fw fa-angle-down",
	"fa fa-fw fa-angle-left",
	"fa fa-fw fa-angle-right",
	"fa fa-fw fa-angle-up",
	"fa fa-fw fa-apple",
	"fa fa-fw fa-archive",
	"fa fa-fw fa-area-chart",
	"fa fa-fw fa-arrow-circle-down",
	"fa fa-fw fa-arrow-circle-left",
	"fa fa-fw fa-arrow-circle-o-down",
	"fa fa-fw fa-arrow-circle-o-left",
	"fa fa-fw fa-arrow-circle-o-right",
	"fa fa-fw fa-arrow-circle-o-up",
	...
	"fa fa-fw fa-bitbucket",
	"fa fa-fw fa-bitbucket-square",
	"fa fa-fw fa-bitcoin",
	"fa fa-fw fa-bold",
	"fa fa-fw fa-bolt",
	"fa fa-fw fa-bomb",
	...
	"fa fa-fw fa-cc",
	"fa fa-fw fa-cc-amex",
	"fa fa-fw fa-cc-discover",
	"fa fa-fw fa-cc-mastercard",
	"fa fa-fw fa-cc-paypal",
	"fa fa-fw fa-cc-stripe",
	"fa fa-fw fa-cc-visa",
	"fa fa-fw fa-certificate",
	"fa fa-fw fa-chain",
	"fa fa-fw fa-chain-broken",
	"fa fa-fw fa-check",
	...
	"fa fa-fw fa-dashcube",
	"fa fa-fw fa-database",
	"fa fa-fw fa-dedent",
	"fa fa-fw fa-delicious",
	"fa fa-fw fa-desktop",
	"fa fa-fw fa-deviantart",
	"fa fa-fw fa-diamond",
	"fa fa-fw fa-digg",
	"fa fa-fw fa-dollar",
	...
	"fa fa-fw fa-facebook-f",
	"fa fa-fw fa-facebook-official",
	"fa fa-fw fa-facebook-square",
	"fa fa-fw fa-fast-backward",
	"fa fa-fw fa-fast-forward",
	"fa fa-fw fa-fax",
	"fa fa-fw fa-female",
	...
	"fa fa-fw fa-font",
	"fa fa-fw fa-forumbee",
	"fa fa-fw fa-forward",
	"fa fa-fw fa-foursquare",
	"fa fa-fw fa-frown-o",
	...
	"fa fa-fw fa-gift",
	"fa fa-fw fa-git",
	"fa fa-fw fa-git-square",
	"fa fa-fw fa-github",
	"fa fa-fw fa-github-alt",
	"fa fa-fw fa-github-square",
	"fa fa-fw fa-gittip",
	"fa fa-fw fa-glass",
	"fa fa-fw fa-globe",
	"fa fa-fw fa-google",
	...
	"fa fa-fw fa-google-wallet",
	"fa fa-fw fa-graduation-cap",
	"fa fa-fw fa-gratipay",
	"fa fa-fw fa-group",
	"fa fa-fw fa-h-square",
	"fa fa-fw fa-hacker-news",
	"fa fa-fw fa-hand-o-down",
	"fa fa-fw fa-hand-o-left",
	"fa fa-fw fa-hand-o-right",
	"fa fa-fw fa-hand-o-up",
	"fa fa-fw fa-hdd-o",
	"fa fa-fw fa-header",
	...
	"fa fa-fw fa-linkedin-square",
	"fa fa-fw fa-linux",
	"fa fa-fw fa-list",
	"fa fa-fw fa-list-alt",
	"fa fa-fw fa-list-ol",
	"fa fa-fw fa-list-ul",
	"fa fa-fw fa-location-arrow",
	"fa fa-fw fa-lock",
	"fa fa-fw fa-long-arrow-down",
	"fa fa-fw fa-long-arrow-left",
	...
	"fa fa-fw fa-mars",
	"fa fa-fw fa-mars-double",
	"fa fa-fw fa-mars-stroke",
	"fa fa-fw fa-mars-stroke-h",
	"fa fa-fw fa-mars-stroke-v",
	"fa fa-fw fa-maxcdn",
	"fa fa-fw fa-meanpath",
	"fa fa-fw fa-medium",
	"fa fa-fw fa-medkit",
	"fa fa-fw fa-meh-o",
	"fa fa-fw fa-mercury",
	...
	"fa fa-fw fa-pied-piper",
	"fa fa-fw fa-pied-piper-alt",
	"fa fa-fw fa-pinterest",
	"fa fa-fw fa-pinterest-p",
	"fa fa-fw fa-pinterest-square",
	"fa fa-fw fa-plane",
	"fa fa-fw fa-play",
	"fa fa-fw fa-play-circle",
	"fa fa-fw fa-play-circle-o",
	"fa fa-fw fa-plug",
	"fa fa-fw fa-plus",
	...
	"fa fa-fw fa-road",
	"fa fa-fw fa-rocket",
	"fa fa-fw fa-rotate-left",
	"fa fa-fw fa-rotate-right",
	"fa fa-fw fa-rouble",
	"fa fa-fw fa-rss",
	...
	"fa fa-fw fa-shield",
	"fa fa-fw fa-ship",
	"fa fa-fw fa-shirtsinbulk",
	"fa fa-fw fa-shopping-cart",
	"fa fa-fw fa-sign-in",
	"fa fa-fw fa-sign-out",
	"fa fa-fw fa-signal",
	"fa fa-fw fa-simplybuilt",
	"fa fa-fw fa-sitemap",
	"fa fa-fw fa-skyatlas",
	"fa fa-fw fa-skype",
	"fa fa-fw fa-slack",
	"fa fa-fw fa-sliders",
	"fa fa-fw fa-slideshare",
	"fa fa-fw fa-smile-o",
	...
	"fa fa-fw fa-stack-exchange",
	"fa fa-fw fa-stack-overflow",
	"fa fa-fw fa-star",
	...
	"fa fa-fw fa-star-o",
	"fa fa-fw fa-steam",
	"fa fa-fw fa-steam-square",
	"fa fa-fw fa-step-backward",
	"fa fa-fw fa-step-forward",
	"fa fa-fw fa-stethoscope",
	"fa fa-fw fa-stop",
	"fa fa-fw fa-street-view",
	"fa fa-fw fa-strikethrough",
	"fa fa-fw fa-stumbleupon",
	"fa fa-fw fa-stumbleupon-circle",
	"fa fa-fw fa-subscript",
	"fa fa-fw fa-subway",
	...
	"fa fa-fw fa-tasks",
	"fa fa-fw fa-taxi",
	"fa fa-fw fa-tencent-weibo",
	"fa fa-fw fa-terminal",
	"fa fa-fw fa-text-height",
	"fa fa-fw fa-text-width",
	"fa fa-fw fa-th",
	...
	"fa fa-fw fa-train",
	"fa fa-fw fa-transgender",
	"fa fa-fw fa-transgender-alt",
	"fa fa-fw fa-trash",
	"fa fa-fw fa-trash-o",
	"fa fa-fw fa-tree",
	"fa fa-fw fa-trello",
	...
	"fa fa-fw fa-tty",
	"fa fa-fw fa-tumblr",
	"fa fa-fw fa-tumblr-square",
	"fa fa-fw fa-turkish-lira",
	"fa fa-fw fa-twitch",
	"fa fa-fw fa-twitter",
	"fa fa-fw fa-twitter-square",
	"fa fa-fw fa-umbrella",
	"fa fa-fw fa-underline",
	"fa fa-fw fa-undo",
	...
	"fa fa-fw fa-users",
	"fa fa-fw fa-venus",
	"fa fa-fw fa-venus-double",
	"fa fa-fw fa-venus-mars",
	"fa fa-fw fa-viacoin",
	"fa fa-fw fa-video-camera",
	"fa fa-fw fa-vimeo-square",
	"fa fa-fw fa-vine",
	"fa fa-fw fa-vk",
	...
	"fa fa-fw fa-weibo",
	"fa fa-fw fa-weixin",
	"fa fa-fw fa-whatsapp",
	"fa fa-fw fa-wheelchair",
	"fa fa-fw fa-wifi",
	"fa fa-fw fa-windows",
	"fa fa-fw fa-won",
	"fa fa-fw fa-wordpress",
	"fa fa-fw fa-wrench",
	"fa fa-fw fa-xing",
	"fa fa-fw fa-xing-square",
	"fa fa-fw fa-yahoo",
	"fa fa-fw fa-yelp",
	"fa fa-fw fa-yen",
	"fa fa-fw fa-youtube",
	"fa fa-fw fa-youtube-play",
	"fa fa-fw fa-youtube-square",
]